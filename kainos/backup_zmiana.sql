...
-- Name: city2; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.city2 OWNER TO postgres;
...
-- Name: countrylanguage; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
-- Dependencies: 192
-- Data for Name: city2; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE ON TABLE city TO postgres;
...
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE ON TABLE country TO postgres;


--
-- TOC entry 3007 (class 0 OID 0)
-- Dependencies: 172
-- Name: countrylanguage; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE countrylanguage FROM PUBLIC;
REVOKE ALL ON TABLE countrylanguage FROM postgres;
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE ON TABLE countrylanguage TO postgres;
